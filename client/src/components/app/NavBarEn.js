         ...
         onOpen={()=>{setDrawer(true)}}>
           ...
           style={{backgroundColor:'orange', height:'100vh'}}
            ...
            <List style = {styleSheet.list}>
               <ListItem key = {1} button divider><Link to='/en' className='link2'>{translate('navbar_home')}</Link></ListItem>
      ...
      <AppBar style={{backgroundColor:'white', boxShadow:'none'}}>
          <div className='container'>
            ...
            <Toolbar style={{color:'orange', marginTop:'-1'}}>
              <Typography><Link className='link' to='/en'>{translate('navbar_home')}</Link></Typography>
